...
- [docs(pr-template): remove mention of `CHANGELOG.md`](https://github.com/nelmio/NelmioApiDocBundle/pull/2622) on [nelmio/NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) (5 days ago)
- [ci(php): run on php 8.5](https://github.com/nelmio/NelmioApiDocBundle/pull/2621) on [nelmio/NelmioApiDocBundle](https://github.com/nelmio/NelmioApiDocBundle) (5 days ago)
...
- [zircote/swagger-php **(6.0.0-RC1)**](https://github.com/zircote/swagger-php/releases/tag/6.0.0-RC1) (2 days ago)
- [symfony/symfony **(v8.0.0-RC3)**](https://github.com/symfony/symfony/releases/tag/v8.0.0-RC3) (5 days ago)
